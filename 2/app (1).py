...
MODULOS_DISPONIBLES = 5   # ← ajusta al número real de módulos de entrega
...
def crear_turno():
    ...
    try:
        ...
        # Asignar módulo automáticamente (distribución aleatoria)
        modulo_asignado = random.randint(1, MODULOS_DISPONIBLES)
